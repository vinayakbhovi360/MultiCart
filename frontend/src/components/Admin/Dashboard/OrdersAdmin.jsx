...
import { adminOrders } from "../../../redux/slices/orderSlice";

const OrdersAdmin = () => {
  const dispatch = useDispatch();
  const { data: { adminOrders : admin } } = useSelector((state) => state.order);
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      <div className="p-6 bg-gradient-to-r from-blue-500 to-blue-600">
        <h2 className="text-2xl font-bold text-white">All Orders (Admin View)</h2>
      </div>
      <div className="p-6">
